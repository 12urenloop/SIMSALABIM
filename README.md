...
This serves as a complete replacement for the stations. Telraam can be directly connected to the builtin webservers.

A similar but different project named [REPLAY](https://github.com/12urenloop/REPLAY) replays station data from previous events instead.
